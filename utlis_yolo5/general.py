...
def non_max_suppression(
    ...
    max_nms = 800  # maximum number of boxes into torchvision.ops.nms()
    time_limit = 30 + 0.05 * bs  # seconds to quit after
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # Compute conf
        #print("class confidence ",x[:, 4:5],x[:, 5:])
